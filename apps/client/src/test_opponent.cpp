...
test_opponent::test_opponent(std::vector<std::string> const& input, std::vector<std::string> const& expected_output)
  : m_input_iteration(0)
...
void test_opponent::sendto(std::string const& data) {
...
std::string test_opponent::recvfrom() { return m_input.at(m_input_iteration++); }
